...
func init() {
	...
	// 3c20b443
	checksum := crc32.ChecksumIEEE([]byte(chineseTraditionalWordList))
	if fmt.Sprintf("%x", checksum) != "3c20b443" {
		panic("chineseTraditionalWordList checksum invalid")
	}
}

// ChineseTraditionalWordList is a slice of mnemonic words taken from the bip39 specification
...
var chineseTraditionalWordList = `的
一
是
在
不
